...
;(function () {
  ...
  function PanHelper() {
    ...
    this.createSideBar = function () {
      ...
      let sideImg = $('<img src="https://baidupan.cdn.bcebos.com/baidu.png" style="margin: 0 auto; position: absolute; left: 0; right: 0; bottom: 100px;">')
    ...
    function batchClick(event) {
      ...
      if (id.indexOf('direct') != -1) {  //aria下载
        ...
        tip = '显示所有选中文件的直接下载链接，文件夹显示为打包下载的链接（仅支持300M以下的文件夹）'
        ...
        getOuterlinkBatchLinkAll(function (batchLinkListAll) {
          ...
          let tip = '请先安装 <a target="_blank" href="https://github.com/syhyz1990/baiduyun/wiki/百度Cookies获取助手-下载地址">百度Cookies获取助手</a> 请将链接复制到支持Aria的下载器中, 推荐使用 <a target="_blank" href="https://github.com/syhyz1990/baiduyun/wiki/XDown-下载地址">XDown</a>'
  ...
  function PanShareHelper() {
    ...
    this.createSideBar = function () {
      ...
      let sidetemp = $('<img src="https://baidupan.cdn.bcebos.com/baidu_share.png" style="margin: 0 auto; position: absolute; left: 0; right: 0; bottom: 100px;">')
    ...
    function ariclinkButtonClick() {
      ...
      if (downloadLink.errno == -20) {
        ...
        let tip = '请先安装 <a target="_blank" href="https://github.com/syhyz1990/baiduyun/wiki/百度Cookies获取助手-下载地址">百度Cookies获取助手</a> 请将链接复制到支持Aria的下载器中, 推荐使用 <a target="_blank" href="https://github.com/syhyz1990/baiduyun/wiki/XDown-下载地址">XDown</a>'
        dialog.open({title: '下载链接（仅显示文件链接）', type: 'shareAriaLink', list: downloadLink.list, tip: tip})
      } else {
        alert(errorMsg.fail)
      }
    }
  ...
  function Dialog() {
    ...
    function createDialog() {
      ...
      let $dialog_copy_button = $('<button id="dialog-copy-button" style="display:none;width: 100px; margin: 5px 0 10px 0; cursor: pointer; background: #cc3235; border: none; height: 30px; color: #fff; border-radius: 3px;">双击链接复制</button>')
  ...
  $(function () {
    ...
    setTimeout(() => {
      ...
      let toptemp = $('<span class="cMEMEF" node-type="help-author"><a href="http://www.2345.com/?39852" style="color: #dd6287" target="_blank">支持作者</a></span>')
