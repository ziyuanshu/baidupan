...
;(function () {
  ...
  function PanHelper() {
    ...
    function addButton() {
      ...
      if (isSuperVIP()) {
        ...
        $dropdownbutton_span.append($apibutton).append($sharebutton);
      }
    ...
    function batchClick(event) {
      ...
      } else if (id.indexOf('aria') != -1) {  //ariaAPI下载
  ...
  function PanShareHelper() {
    ...
    function addButton() {
      ...
      $dropdownbutton_span./*append($downloadButton).*/append($linkButton).append($ariclinkButton).append($saveButton).append($github);
